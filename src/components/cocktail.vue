        ...
        <div class="cocktailheader">
            <img :src="data.drinks[0].strDrinkThumb+`/preview`" />
                <div class="details">
                    ...
                    <!-- <p>Ingredients: {{ data.drinks[0].strIngredient1 }}, {{ data.drinks[0].strIngredient2 }}, {{ data.drinks[0].strIngredient3 }}, {{ data.drinks[0].strIngredient4 }}, {{ data.drinks[0].strIngredient5 }}</p> -->
                </div>
        </div>
    </div>
</template>
